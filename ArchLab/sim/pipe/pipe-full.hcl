...
word f_predPC = [
    ...
    # f_icode == IJXX && !e_Cnd && E_icode == IOPQ && E_ifun == 0 && D_icode != IOPQ && f_ifun == 1: f_valP;
    # f_icode == IJXX &&  e_Cnd && E_icode == IOPQ && E_ifun == 0 && D_icode != IOPQ && f_ifun == 1: f_valC;
    # how to always predict not taken ?
    # E_icode == IJXX && e_Cnd: E_valC;
    f_icode in { ICALL } : f_valC;
    f_icode == IJXX : f_valC;
    # f_icode in { IJXX  }: f_valP; # predict not taken 
    
    # E_icode == IJXX && E_ifun == 1 && e_Cnd:
    # e_Cnd && E_icode == IOPQ && E_ifun == 0 : 
    # f_icode in { IJXX } : f_valC;
	# f_icode == IJXX:f_valP;
    1 : f_valP;
];
...
word d_valA = [
	D_icode in { ICALL, IJXX } : D_valP;#D_valP; # Use incremented PC
